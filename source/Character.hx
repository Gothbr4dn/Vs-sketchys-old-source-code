...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-sketch':
				tex = Paths.getSparrowAtlas('sketch/gfSketch');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'sketchy':
				frames = Paths.getSparrowAtlas('sketch/sketchy_assets');

				animation.addByPrefix('idle','sketchy idle', 24, false);
				animation.addByPrefix('singUP','sketchy up', 24, false);
				animation.addByPrefix('singRIGHT','sketchy right', 24, false);
				animation.addByPrefix('singLEFT','sketchy left', 24, false);
				animation.addByPrefix('singDOWN','sketchy down', 24, false);
			...
			case 'crumple':
				frames = Paths.getSparrowAtlas('sketch/crumple');

				animation.addByPrefix('idle','crumpleidle', 24, false);
				animation.addByPrefix('singUP','crumpleup', 24, false);
				animation.addByPrefix('singRIGHT','crumpleright', 24, false);
				animation.addByPrefix('singLEFT','crumpleleft', 24, false);
				animation.addByPrefix('singDOWN','crumpledown', 24, false);
			...
			case 'bf-sketch':
				var tex = Paths.getSparrowAtlas('sketch/bfSketch');
				frames = tex;
				...
				animation.addByPrefix('hey', 'bf-sketch HEY', 24, false);
